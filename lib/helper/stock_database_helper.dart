...
class StockDatabaseHelper {
  ...
  static const columnRemark1 = 'remark1';


  // make singleton class
  StockDatabaseHelper._privateConstructor();
  static final StockDatabaseHelper instance = StockDatabaseHelper._privateConstructor();
